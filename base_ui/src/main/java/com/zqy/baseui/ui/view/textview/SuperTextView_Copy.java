 ...
 * Des:
 */
public class SuperTextView_Copy extends AppCompatTextView {


    public SuperTextView_Copy(Context context) {
        super(context);
        init(context, null);
    }

    public SuperTextView_Copy(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SuperTextView_Copy(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        Drawable bg = superTextViewDrawable.initStateListDrawable(context, attrs);
