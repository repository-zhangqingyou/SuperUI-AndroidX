...
public final class R {
    ...
    public static final class styleable {
        ...
        static {
            ...
            RecyclerView = getStyleableId("")RecyclerView;
            RecyclerView_android_clipToPadding = getStyleableId("")RecyclerView_android_clipToPadding;
            RecyclerView_android_descendantFocusability = getStyleableId("")RecyclerView_android_descendantFocusability;
            RecyclerView_android_orientation = getStyleableId("")RecyclerView_android_orientation;
            RecyclerView_fastScrollEnabled = getStyleableId("")RecyclerView_fastScrollEnabled;
            RecyclerView_fastScrollHorizontalThumbDrawable = getStyleableId("")RecyclerView_fastScrollHorizontalThumbDrawable;
            RecyclerView_fastScrollHorizontalTrackDrawable = getStyleableId("")RecyclerView_fastScrollHorizontalTrackDrawable;
            RecyclerView_fastScrollVerticalThumbDrawable = getStyleableId("")RecyclerView_fastScrollVerticalThumbDrawable;
            RecyclerView_fastScrollVerticalTrackDrawable = getStyleableId("")RecyclerView_fastScrollVerticalTrackDrawable;
            RecyclerView_layoutManager = getStyleableId("")RecyclerView_layoutManager;
            RecyclerView_reverseLayout = getStyleableId("")RecyclerView_reverseLayout;
            RecyclerView_spanCount = getStyleableId("")RecyclerView_spanCount;
            RecyclerView_stackFromEnd = getStyleableId("")RecyclerView_stackFromEnd;
            ViewPager2 = getStyleableId("")ViewPager2;
            ViewPager2_android_orientation = getStyleableId("")ViewPager2_android_orientation;
        }
    }
    ...
    public static final class attr {
        ...
        static {
            ...
            recyclerViewStyle = R.attr.recyclerViewStyle;
