 ...
 */
package com.zqy.http.okgo.adapter;

import com.zqy.http.okgo.cache.CacheEntity;
import com.zqy.http.okgo.cache.policy.CachePolicy;
import com.zqy.http.okgo.cache.policy.DefaultCachePolicy;
import com.zqy.http.okgo.cache.policy.FirstCacheRequestPolicy;
import com.zqy.http.okgo.cache.policy.NoCachePolicy;
import com.zqy.http.okgo.cache.policy.NoneCacheRequestPolicy;
import com.zqy.http.okgo.cache.policy.RequestFailedCachePolicy;
 ...
 * ================================================
 */
public class CacheCall<T> implements com.zqy.http.okgo.adapter.Call<T> {
