 ...
 */
package com.zqy.http.okgo.utils;
...
import com.zqy.http.okhttp3.FormBody;
import com.zqy.http.okhttp3.Headers;
import com.zqy.http.okhttp3.MediaType;
import com.zqy.http.okhttp3.MultipartBody;
...
public class HttpUtils {
    ...
    public static String createUrlFromParams(String url, Map<String, List<String>> params) {
        try {
            ...
            com.zqy.http.okgo.utils.OkLogger.printStackTrace(e);
        }
        return url;
    }
