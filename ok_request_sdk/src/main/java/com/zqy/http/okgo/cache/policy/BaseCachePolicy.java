 ...
 */
package com.zqy.http.okgo.cache.policy;
...
import com.zqy.http.okgo.db.CacheManager;
import com.zqy.http.okgo.exception.HttpException;
import com.zqy.http.okgo.model.Response;
import com.zqy.http.okgo.request.base.Request;
import com.zqy.http.okgo.utils.HeaderParser;
...
public abstract class BaseCachePolicy<T> implements CachePolicy<T> {
    ...
    @Override
    public boolean onAnalysisResponse(Call call, com.zqy.http.okhttp3.Response response) {
        return false;
    }
    ...
    protected Response<T> requestNetworkSync() {
        try {
            com.zqy.http.okhttp3.Response response = rawCall.execute();
    ...
    protected void requestNetworkAsync() {
        rawCall.enqueue(new com.zqy.http.okhttp3.Callback() {
            @Override
            ...
            @Override
            public void onResponse(Call call, com.zqy.http.okhttp3.Response response) throws IOException {
                int responseCode = response.code();
