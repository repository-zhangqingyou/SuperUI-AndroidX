...
import com.zqy.http.okgo.adapter.AdapterParam;
import com.zqy.http.okgo.adapter.CacheCall;
import com.zqy.http.okgo.adapter.Call;
import com.zqy.http.okgo.adapter.CallAdapter;
import com.zqy.http.okgo.cache.CacheEntity;
import com.zqy.http.okgo.cache.CacheMode;
import com.zqy.http.okgo.cache.policy.CachePolicy;
import com.zqy.http.okgo.callback.Callback;
import com.zqy.http.okgo.convert.Converter;
import com.zqy.http.okgo.model.HttpHeaders;
import com.zqy.http.okgo.model.HttpMethod;
import com.zqy.http.okgo.model.HttpParams;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    protected transient com.zqy.http.okhttp3.Request mRequest;
    ...
    public com.zqy.http.okhttp3.Request getRequest() {
        return mRequest;
    }
    ...
    public abstract com.zqy.http.okhttp3.Request generateRequest(RequestBody requestBody);

    /** 获取okhttp的同步call对象 */
    public com.zqy.http.okhttp3.Call getRawCall() {
        //构建请求体，返回call对象
