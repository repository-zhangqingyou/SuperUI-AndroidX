...
import com.zqy.sutils.code.RSAEncrypt;
...
public class Request {
    ...
    public Map<String, Object> getParams(Map<String, Object> map) {
        ...
        String user_token = "";
        String user_id = "";
        UserDataContainer.UserData userData = UserDataContainer.getInstance().getUserData();
        if (userData != null) {
     ...
     * 测试
     */
    public void test(JsonEntityCallback<CodeAndMsg> jsonBeanCallback) {
