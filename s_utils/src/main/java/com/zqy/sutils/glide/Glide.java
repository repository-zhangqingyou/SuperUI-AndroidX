...
import com.zqy.sutils.glide.load.data.InputStreamRewinder;
import com.zqy.sutils.glide.load.engine.Engine;
...
import com.zqy.sutils.glide.load.engine.prefill.BitmapPreFiller;
import com.zqy.sutils.glide.load.engine.prefill.PreFillType;
import com.zqy.sutils.glide.load.model.AssetUriLoader;
import com.zqy.sutils.glide.load.model.ByteArrayLoader;
import com.zqy.sutils.glide.load.model.ByteBufferEncoder;
import com.zqy.sutils.glide.load.model.ByteBufferFileLoader;
import com.zqy.sutils.glide.load.model.DataUrlLoader;
import com.zqy.sutils.glide.load.model.FileLoader;
import com.zqy.sutils.glide.load.model.GlideUrl;
import com.zqy.sutils.glide.load.model.MediaStoreFileLoader;
import com.zqy.sutils.glide.load.model.ResourceLoader;
import com.zqy.sutils.glide.load.model.StreamEncoder;
import com.zqy.sutils.glide.load.model.StringLoader;
import com.zqy.sutils.glide.load.model.UnitModelLoader;
import com.zqy.sutils.glide.load.model.UriLoader;
import com.zqy.sutils.glide.load.model.UrlUriLoader;
import com.zqy.sutils.glide.load.model.stream.HttpGlideUrlLoader;
import com.zqy.sutils.glide.load.model.stream.HttpUriLoader;
import com.zqy.sutils.glide.load.model.stream.MediaStoreImageThumbLoader;
import com.zqy.sutils.glide.load.model.stream.MediaStoreVideoThumbLoader;
import com.zqy.sutils.glide.load.model.stream.UrlLoader;
import com.zqy.sutils.glide.load.resource.bitmap.BitmapDrawableDecoder;
import com.zqy.sutils.glide.load.resource.bitmap.BitmapDrawableEncoder;
import com.zqy.sutils.glide.load.resource.bitmap.BitmapEncoder;
import com.zqy.sutils.glide.load.resource.bitmap.ByteBufferBitmapDecoder;
import com.zqy.sutils.glide.load.resource.bitmap.DefaultImageHeaderParser;
import com.zqy.sutils.glide.load.resource.bitmap.Downsampler;
import com.zqy.sutils.glide.load.resource.bitmap.ResourceBitmapDecoder;
import com.zqy.sutils.glide.load.resource.bitmap.StreamBitmapDecoder;
import com.zqy.sutils.glide.load.resource.bitmap.UnitBitmapDecoder;
import com.zqy.sutils.glide.load.resource.bitmap.VideoDecoder;
import com.zqy.sutils.glide.load.resource.bytes.ByteBufferRewinder;
import com.zqy.sutils.glide.load.resource.drawable.ResourceDrawableDecoder;
import com.zqy.sutils.glide.load.resource.drawable.UnitDrawableDecoder;
import com.zqy.sutils.glide.load.resource.file.FileDecoder;
import com.zqy.sutils.glide.load.resource.gif.ByteBufferGifDecoder;
import com.zqy.sutils.glide.load.resource.gif.GifDrawable;
import com.zqy.sutils.glide.load.resource.gif.GifDrawableEncoder;
import com.zqy.sutils.glide.load.resource.gif.GifFrameResourceDecoder;
import com.zqy.sutils.glide.load.resource.gif.StreamGifDecoder;
import com.zqy.sutils.glide.load.resource.transcode.BitmapBytesTranscoder;
import com.zqy.sutils.glide.load.resource.transcode.BitmapDrawableTranscoder;
import com.zqy.sutils.glide.load.resource.transcode.DrawableBytesTranscoder;
import com.zqy.sutils.glide.load.resource.transcode.GifDrawableBytesTranscoder;
...
import com.zqy.sutils.glide.module.GlideModule;
import com.zqy.sutils.glide.module.ManifestParser;
import com.zqy.sutils.glide.request.RequestOptions;
import com.zqy.sutils.glide.request.target.ImageViewTargetFactory;
 ...
 * {@link com.zqy.sutils.glide.load.engine.cache.DiskCache} and {@link MemoryCache}.
 */
public class Glide implements ComponentCallbacks2 {
        ...
        try {
            Class<GeneratedAppGlideModule> clazz =
                    (Class<GeneratedAppGlideModule>)
                            Class.forName("com.zqy.sutils.glide.GeneratedAppGlideModuleImpl");
     ...
     * {@link com.zqy.sutils.glide.load.Transformation}s. Use outside of these classes is not generally
     * recommended. </p>
     */
