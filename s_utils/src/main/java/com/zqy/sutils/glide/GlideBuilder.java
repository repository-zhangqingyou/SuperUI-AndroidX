...
import com.zqy.sutils.glide.load.engine.bitmap_recycle.BitmapPoolAdapter;
import com.zqy.sutils.glide.load.engine.bitmap_recycle.LruArrayPool;
import com.zqy.sutils.glide.load.engine.bitmap_recycle.LruBitmapPool;
import com.zqy.sutils.glide.load.engine.cache.DiskCache;
import com.zqy.sutils.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import com.zqy.sutils.glide.load.engine.cache.LruResourceCache;
import com.zqy.sutils.glide.load.engine.cache.MemoryCache;
import com.zqy.sutils.glide.load.engine.cache.MemorySizeCalculator;
import com.zqy.sutils.glide.load.engine.executor.GlideExecutor;
import com.zqy.sutils.glide.manager.ConnectivityMonitorFactory;
import com.zqy.sutils.glide.manager.DefaultConnectivityMonitorFactory;
import com.zqy.sutils.glide.manager.RequestManagerRetriever;
import com.zqy.sutils.glide.manager.RequestManagerRetriever.RequestManagerFactory;
...
public final class GlideBuilder {
   ...
   * {@link com.zqy.sutils.glide.load.engine.Resource}s that are not currently in use.
   *
   ...
   * com.zqy.sutils.glide.load.engine.Resource} data on disk.
   *
   ...
   * {@link com.zqy.sutils.glide.load.engine.Resource}s that are not already in the cache.
   *
  ...
  /**
   * Sets the {@link GlideExecutor} to use when retrieving
   * {@link com.zqy.sutils.glide.load.engine.Resource}s that are currently in Glide's disk caches.
   *
   ...
   * of {@link com.zqy.sutils.glide.load.resource.gif.GifDrawable}s.
   *
   ...
   * {@link com.zqy.sutils.glide.load.resource.gif.GifDrawable} or
  ...
  public <T> GlideBuilder setDefaultTransitionOptions(
       Class<T> clazz, TransitionOptions<?, T> options) {
   ...
   * to use to notify {@link com.zqy.sutils.glide.RequestManager} of connectivity events.
  ...
  com.zqy.sutils.glide.Glide build( Context context) {
