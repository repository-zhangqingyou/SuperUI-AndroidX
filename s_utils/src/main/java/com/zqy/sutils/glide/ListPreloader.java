...
import com.zqy.sutils.glide.request.target.BaseTarget;
...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
  ...
  public interface PreloadModelProvider<U> {
     ...
     * {@link com.zqy.sutils.glide.request.RequestOptions#override(int, int)} to do so.
     *
  ...
  /**
   * Constructor for {@link com.zqy.sutils.glide.ListPreloader} that accepts interfaces for providing
