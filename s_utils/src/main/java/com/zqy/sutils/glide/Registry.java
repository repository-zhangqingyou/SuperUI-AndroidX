...
import com.zqy.sutils.glide.load.data.DataRewinderRegistry;
import com.zqy.sutils.glide.load.engine.DecodePath;
import com.zqy.sutils.glide.load.engine.LoadPath;
...
import com.zqy.sutils.glide.load.model.ModelLoaderRegistry;
import com.zqy.sutils.glide.load.resource.transcode.ResourceTranscoder;
import com.zqy.sutils.glide.load.resource.transcode.TranscoderRegistry;
import com.zqy.sutils.glide.provider.EncoderRegistry;
import com.zqy.sutils.glide.provider.ImageHeaderParserRegistry;
import com.zqy.sutils.glide.provider.LoadPathCache;
import com.zqy.sutils.glide.provider.ModelToResourceClassCache;
import com.zqy.sutils.glide.provider.ResourceDecoderRegistry;
import com.zqy.sutils.glide.provider.ResourceEncoderRegistry;
...
public class Registry {
   ...
   * {@link com.zqy.sutils.glide.load.resource.gif.GifDrawable} etc).
   ...
   * {@link com.zqy.sutils.glide.load.resource.gif.GifDrawable} and any other subclass.
   *
  ...
  public <TResource, Transcode> Registry register(
       Class<TResource> resourceClass,  Class<Transcode> transcodeClass,
  ...
  public <Data, TResource, Transcode> LoadPath<Data, TResource, Transcode> getLoadPath(
       Class<Data> dataClass,  Class<TResource> resourceClass,
  ...
  public <Model, TResource, Transcode> List<Class<?>> getRegisteredResourceClasses(
       Class<Model> modelClass,  Class<TResource> resourceClass,
       Class<Transcode> transcodeClass) {
