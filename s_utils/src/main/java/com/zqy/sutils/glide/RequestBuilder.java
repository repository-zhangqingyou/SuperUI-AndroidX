...
import com.zqy.sutils.glide.request.ErrorRequestCoordinator;
import com.zqy.sutils.glide.request.FutureTarget;
import com.zqy.sutils.glide.request.Request;
import com.zqy.sutils.glide.request.RequestCoordinator;
import com.zqy.sutils.glide.request.RequestFutureTarget;
import com.zqy.sutils.glide.request.RequestListener;
import com.zqy.sutils.glide.request.RequestOptions;
import com.zqy.sutils.glide.request.SingleRequest;
import com.zqy.sutils.glide.request.ThumbnailRequestCoordinator;
import com.zqy.sutils.glide.request.target.PreloadTarget;
import com.zqy.sutils.glide.request.target.Target;
import com.zqy.sutils.glide.request.target.ViewTarget;
import com.zqy.sutils.glide.signature.ApplicationVersionSignature;
...
import static com.zqy.sutils.glide.request.RequestOptions.signatureOf;
...
public class RequestBuilder<TranscodeType> implements Cloneable,
        com.zqy.sutils.glide.ModelTypes<RequestBuilder<TranscodeType>> {
  // Used in generated subclasses
  protected static final RequestOptions DOWNLOAD_ONLY_OPTIONS =
      new RequestOptions().diskCacheStrategy(DiskCacheStrategy.DATA).priority(com.zqy.sutils.glide.Priority.LOW)
  ...
  private final com.zqy.sutils.glide.Glide glide;
  ...
  @CheckResult
  public RequestBuilder<TranscodeType> thumbnail(
      RequestBuilder<TranscodeType>... thumbnails) {
   ...
   * com.zqy.sutils.glide.load.model.ModelLoader}, {@link com.zqy.sutils.glide.load.ResourceDecoder},
   ...
   * {@link com.zqy.sutils.glide.load.model.ModelLoader} or
   * {@link com.zqy.sutils.glide.load.ResourceDecoder} instead of using this method.
   *
   ...
   * {@link RequestOptions#signature(com.zqy.sutils.glide.load.Key)} to
   ...
   * {@link com.zqy.sutils.glide.load.model.UriLoader}.
   */
   ...
   * {@link RequestOptions#signature(com.zqy.sutils.glide.load.Key)}
   ...
   * {@link com.zqy.sutils.glide.load.model.ModelLoaderFactory} currently registered or
   * {@link Integer} to load the image represented by the given {@link Integer} resource id.
   * Defaults to {@link com.zqy.sutils.glide.load.model.ResourceLoader} to load resource id models.
   *
   ...
   * transformed (other than {@link com.zqy.sutils.glide.load.resource.gif.GifDrawable}). To avoid
  ...
  @CheckResult
  @Override
  public RequestBuilder<TranscodeType> load(@RawRes @DrawableRes Integer resourceId) {
   ...
   * @see com.zqy.sutils.glide.ListPreloader
   */
  ...
  private com.zqy.sutils.glide.Priority getThumbnailPriority( com.zqy.sutils.glide.Priority current) {
    switch (current) {
      case LOW:
        return com.zqy.sutils.glide.Priority.NORMAL;
      case NORMAL:
        return com.zqy.sutils.glide.Priority.HIGH;
      case HIGH:
      case IMMEDIATE:
        return com.zqy.sutils.glide.Priority.IMMEDIATE;
      default:
  ...
  private Request buildRequestRecursive(
      ...
      TransitionOptions<?, ? super TranscodeType> transitionOptions,
      com.zqy.sutils.glide.Priority priority,
      int overrideWidth,
      int overrideHeight,
      RequestOptions requestOptions) {
  ...
  private Request buildThumbnailRequestRecursive(
    ...
    if (thumbnailBuilder != null) {
      ...
      com.zqy.sutils.glide.Priority thumbPriority = thumbnailBuilder.requestOptions.isPrioritySet()
