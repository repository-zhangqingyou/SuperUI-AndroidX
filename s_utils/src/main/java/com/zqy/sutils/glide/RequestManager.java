...
import com.zqy.sutils.glide.load.engine.DiskCacheStrategy;
import com.zqy.sutils.glide.load.resource.gif.GifDrawable;
import com.zqy.sutils.glide.manager.ConnectivityMonitor;
import com.zqy.sutils.glide.manager.ConnectivityMonitorFactory;
import com.zqy.sutils.glide.manager.Lifecycle;
import com.zqy.sutils.glide.manager.LifecycleListener;
import com.zqy.sutils.glide.manager.RequestManagerTreeNode;
import com.zqy.sutils.glide.manager.RequestTracker;
import com.zqy.sutils.glide.manager.TargetTracker;
import com.zqy.sutils.glide.request.Request;
import com.zqy.sutils.glide.request.RequestOptions;
import com.zqy.sutils.glide.request.target.Target;
import com.zqy.sutils.glide.request.target.ViewTarget;
...
import static com.zqy.sutils.glide.request.RequestOptions.decodeTypeOf;
import static com.zqy.sutils.glide.request.RequestOptions.diskCacheStrategyOf;
import static com.zqy.sutils.glide.request.RequestOptions.skipMemoryCacheOf;
 ...
 *
 * @see com.zqy.sutils.glide.Glide#with(android.app.Activity)
 * @see com.zqy.sutils.glide.Glide#with(android.support.v4.app.FragmentActivity)
 * @see com.zqy.sutils.glide.Glide#with(android.app.Fragment)
 * @see com.zqy.sutils.glide.Glide#with(android.support.v4.app.Fragment)
 * @see com.zqy.sutils.glide.Glide#with(Context)
 */
public class RequestManager implements LifecycleListener,
        com.zqy.sutils.glide.ModelTypes<com.zqy.sutils.glide.RequestBuilder<Drawable>> {
  ...
  protected final com.zqy.sutils.glide.Glide glide;
  ...
  public RequestManager(
           com.zqy.sutils.glide.Glide glide,  Lifecycle lifecycle,
   ...
   * com.zqy.sutils.glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}. If there are conflicts, the options
   * applied here will win. Note that this method does not mutate options provided to
   * {@link com.zqy.sutils.glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}.
   *
   ...
   *
   * @see com.zqy.sutils.glide.RequestBuilder#apply(RequestOptions)
   *
  ...
  @CheckResult
  public com.zqy.sutils.glide.RequestBuilder<Bitmap> asBitmap() {
  ...
  @CheckResult
  public com.zqy.sutils.glide.RequestBuilder<GifDrawable> asGif() {
    return as(GifDrawable.class).apply(DECODE_TYPE_GIF);
  }

  /**
   * Attempts to always load the resource using any registered {@link
   * com.zqy.sutils.glide.load.ResourceDecoder}s that can decode any subclass of {@link Drawable}.
   *
  ...
  @CheckResult
  public com.zqy.sutils.glide.RequestBuilder<Drawable> asDrawable() {
    return as(Drawable.class);
  }

  /**
   * Equivalent to calling {@link #asDrawable()} and then {@link com.zqy.sutils.glide.RequestBuilder#load(Bitmap)}.
   *
  ...
  @CheckResult
  @Override
  public com.zqy.sutils.glide.RequestBuilder<Drawable> load(@Nullable Bitmap bitmap) {
    return asDrawable().load(bitmap);
  }

  /**
   * Equivalent to calling {@link #asDrawable()} and then {@link com.zqy.sutils.glide.RequestBuilder#load(Drawable)}.
   *
   * @return A new request builder for loading a {@link Drawable} using the given model.
   */
  ...
  @CheckResult
  @Override
  public com.zqy.sutils.glide.RequestBuilder<Drawable> load(@Nullable Drawable drawable) {
    return asDrawable().load(drawable);
  }

  /**
   * Equivalent to calling {@link #asDrawable()} and then {@link com.zqy.sutils.glide.RequestBuilder#load(String)}.
   *
   * @return A new request builder for loading a {@link Drawable} using the given model.
   */
  ...
  @CheckResult
  @Override
  public com.zqy.sutils.glide.RequestBuilder<Drawable> load(@Nullable String string) {
    return asDrawable().load(string);
  }

  /**
   * Equivalent to calling {@link #asDrawable()} and then {@link com.zqy.sutils.glide.RequestBuilder#load(Uri)}.
   *
   * @return A new request builder for loading a {@link Drawable} using the given model.
   */
  ...
  @CheckResult
  @Override
  public com.zqy.sutils.glide.RequestBuilder<Drawable> load(@Nullable Uri uri) {
    return asDrawable().load(uri);
  }

  /**
   * Equivalent to calling {@link #asDrawable()} and then {@link com.zqy.sutils.glide.RequestBuilder#load(File)}.
   *
   * @return A new request builder for loading a {@link Drawable} using the given model.
   */
  ...
  @CheckResult
  @Override
  public com.zqy.sutils.glide.RequestBuilder<Drawable> load(@Nullable File file) {
    return asDrawable().load(file);
  }

  /**
   * Equivalent to calling {@link #asDrawable()} and then {@link com.zqy.sutils.glide.RequestBuilder#load(Integer)}.
   *
   * @return A new request builder for loading a {@link Drawable} using the given model.
   */
  ...
  @CheckResult
  @Override
  public com.zqy.sutils.glide.RequestBuilder<Drawable> load(@RawRes @DrawableRes Integer resourceId) {
    return asDrawable().load(resourceId);
  }

  /**
   * Equivalent to calling {@link #asDrawable()} and then {@link com.zqy.sutils.glide.RequestBuilder#load(URL)}.
   *
   * @return A new request builder for loading a {@link Drawable} using the given model.
   */
  @SuppressWarnings("deprecation")
  ...
  @Override
  @Deprecated
  public com.zqy.sutils.glide.RequestBuilder<Drawable> load(@Nullable URL url) {
    return asDrawable().load(url);
  }


  /**
   * Equivalent to calling {@link #asDrawable()} and then {@link com.zqy.sutils.glide.RequestBuilder#load(byte[])}.
   *
   * @return A new request builder for loading a {@link Drawable} using the given model.
   */
  ...
  @CheckResult
  @Override
  public com.zqy.sutils.glide.RequestBuilder<Drawable> load(@Nullable byte[] model) {
    return asDrawable().load(model);
  }

  /**
   * A helper method equivalent to calling {@link #asDrawable()} and then {@link
   * com.zqy.sutils.glide.RequestBuilder#load(Object)} with the given model.
   *
   * @return A new request builder for loading a {@link Drawable} using the given model.
   */
  ...
  @CheckResult
  @Override
  public com.zqy.sutils.glide.RequestBuilder<Drawable> load(@Nullable Object model) {
    return asDrawable().load(model);
  }
  ...
  @CheckResult
  public com.zqy.sutils.glide.RequestBuilder<File> downloadOnly() {
  ...
  @CheckResult
  public com.zqy.sutils.glide.RequestBuilder<File> download(@Nullable Object model) {
  ...
  @CheckResult
  public com.zqy.sutils.glide.RequestBuilder<File> asFile() {
    return as(File.class).apply(skipMemoryCacheOf(true));
  }

  /**
   * Attempts to load the resource using any registered
   * {@link com.zqy.sutils.glide.load.ResourceDecoder}s
  ...
  @CheckResult
  public <ResourceType> com.zqy.sutils.glide.RequestBuilder<ResourceType> as(
