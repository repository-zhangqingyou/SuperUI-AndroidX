...
import com.zqy.sutils.glide.request.transition.NoTransition;
import com.zqy.sutils.glide.request.transition.TransitionFactory;
import com.zqy.sutils.glide.request.transition.ViewAnimationFactory;
import com.zqy.sutils.glide.request.transition.ViewPropertyAnimationFactory;
import com.zqy.sutils.glide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>,
   ...
   * {@link com.zqy.sutils.glide.request.transition.Transition} for each request started with these
