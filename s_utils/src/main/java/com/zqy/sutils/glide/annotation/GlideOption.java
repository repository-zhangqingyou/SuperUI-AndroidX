package com.zqy.sutils.glide.annotation;
 ...
 * {@code com.zqy.sutils.glide.request.RequestOptions}.
 *
 * <p>All annotated methods will be added to a single
 * {@code com.zqy.sutils.glide.request.RequestOptions} implementation generated per application.
 ...
 * {@code com.zqy.sutils.glide.request.RequestOptions} object with one or more methods called on it.
 * You must not return a newly instantiated {@code com.zqy.sutils.glide.request.RequestOptions} object
 * as doing so my cause a {@code ClassCastException} at runtime. Calling either
 * {@code com.zqy.sutils.glide.request.RequestOptions#autoClone()} or
 * {@code com.zqy.sutils.glide.request.RequestOptions#lock()} is safe, but unnecessary and should
 ...
 * {@code com.zqy.sutils.glide.request.RequestOptions} object is cloned before it is passed to this
 * method to avoid an option method returning a new instance, but using methods like
 * {@code com.zqy.sutils.glide.request.RequestOptions#clone()} or
 * {@code com.zqy.sutils.glide.request.RequestOptions#autoClone()} can result in options applied in
...
public @interface GlideOption {
   ...
   * {@code com.zqy.sutils.glide.request.RequestOptions#autoClone()}.
   *
   ...
   * with {@code com.zqy.sutils.glide.RequestBuilder#apply}. The static factory method by default
   * simply creates a new {@code com.zqy.sutils.glide.request.RequestOptions} object, calls the
