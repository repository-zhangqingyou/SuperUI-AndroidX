...
public interface GifDecoder {
   ...
   * A count of 0 ({@link com.zqy.sutils.glide.gifdecoder.GifHeader#NETSCAPE_LOOP_COUNT_FOREVER}) means repeat indefinitely.
   ...
   *         else -1 ({@link com.zqy.sutils.glide.gifdecoder.GifHeader#NETSCAPE_LOOP_COUNT_DOES_NOT_EXIST}).
   */
   ...
   *         <tr><td>{@link com.zqy.sutils.glide.gifdecoder.GifHeader#NETSCAPE_LOOP_COUNT_FOREVER}</td>
   *             <td>{@link #TOTAL_ITERATION_COUNT_FOREVER}</td></tr>
   *         <tr><td>{@link com.zqy.sutils.glide.gifdecoder.GifHeader#NETSCAPE_LOOP_COUNT_DOES_NOT_EXIST}</td>
   *             <td>{@code 1}</td></tr>
   *         <tr><td>{@code n (n > 0)}</td>
   *             <td>{@code n + 1}</td></tr>
   *     </table>
   ...
   * #setData(com.zqy.sutils.glide.gifdecoder.GifHeader, byte[])}, as well as internal buffers.
   */
  int getByteSize();
  ...
  void setData( com.zqy.sutils.glide.gifdecoder.GifHeader header,  byte[] data);

  void setData( com.zqy.sutils.glide.gifdecoder.GifHeader header,  ByteBuffer buffer);
