 ...
 * be shared by one or more {@link com.zqy.sutils.glide.gifdecoder.GifDecoder}s to play the same
...
public class GifHeader {
  ...
  com.zqy.sutils.glide.gifdecoder.GifFrame currentFrame;
  final List<com.zqy.sutils.glide.gifdecoder.GifFrame> frames = new ArrayList<>();
