...
import static com.zqy.sutils.glide.gifdecoder.GifDecoder.STATUS_FORMAT_ERROR;
...
/**
 * A class responsible for creating {@link com.zqy.sutils.glide.gifdecoder.GifHeader}s from data
...
public class GifHeaderParser {
   ...
   *
   * @see com.zqy.sutils.glide.gifdecoder.GifFrame.GifDisposalMethod possible values
   */
  ...
  public GifHeaderParser setData(@Nullable byte[] data) {
    if (data != null) {
      ...
      rawData = null;
      header.status = com.zqy.sutils.glide.gifdecoder.GifDecoder.STATUS_OPEN_ERROR;
    }
    return this;
  }
      ...
      switch (code) {
        case IMAGE_SEPARATOR:
          ...
          if (header.currentFrame == null) {
            header.currentFrame = new com.zqy.sutils.glide.gifdecoder.GifFrame();
          }
          readBitmap();
          break;
