 ...
 * {@link android.graphics.Bitmap}s returned by {@link com.zqy.sutils.glide.load.ResourceDecoder}s.
 *
 * <p> Note - In some cases it may not be possible to obey the requested setting, not all
 * {@link com.zqy.sutils.glide.load.resource.bitmap.Downsampler}s support setting formats and certain
...
public enum DecodeFormat {
  /**
   * Bitmaps returned by the {@link com.zqy.sutils.glide.load.ResourceDecoder}.
   ...
   * request, use {@link com.zqy.sutils.glide.request.RequestOptions#disallowHardwareConfig()}.
   *
   ...
   * {@link com.zqy.sutils.glide.load.resource.bitmap.Downsampler#ALLOW_HARDWARE_CONFIG} to false
   * instead.
   */
  @Deprecated
