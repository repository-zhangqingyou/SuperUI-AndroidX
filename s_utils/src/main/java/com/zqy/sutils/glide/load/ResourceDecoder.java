...
public interface ResourceDecoder<T, Z> {
   ...
   * {@link #decode(Object, int, int, com.zqy.sutils.glide.load.Options)} if the data is partial or formatted incorrectly.
   */
  boolean handles( T source,  com.zqy.sutils.glide.load.Options options) throws IOException;
   ...
   *                com.zqy.sutils.glide.request.target.Target#SIZE_ORIGINAL} to indicate the original
   *                resource width.
