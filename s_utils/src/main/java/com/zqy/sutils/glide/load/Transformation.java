...
public interface Transformation<T> extends Key {
   ...
   * com.zqy.sutils.glide.load.engine.DiskCacheStrategy#NONE} or make sure {@link
   ...
   *                  com.zqy.sutils.glide.request.target.Target#SIZE_ORIGINAL} to indicate the
  ...
  Resource<T> transform( Context context,  Resource<T> resource,
