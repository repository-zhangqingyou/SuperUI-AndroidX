 ...
 *
 * <p> A new instance is
 * created per resource load by {@link com.zqy.sutils.glide.load.model.ModelLoader}. {@link
 * #loadData(Priority, com.zqy.sutils.glide.load.data.DataFetcher.DataCallback)}
 ...
 * com.zqy.sutils.glide.load.data.DataFetcher.DataCallback)}} is called, then so {@link #cleanup()}
 * will be called. </p>
 *
...
public interface DataFetcher<T> {
   ...
   * com.zqy.sutils.glide.load.data.DataFetcher.DataCallback)} has been decoded by the
   * {@link com.zqy.sutils.glide.load.ResourceDecoder}.
   *
   * <p> Note - this method will be run on a background thread so blocking I/O is safe. </p>
   */
  void cleanup();
