...
public interface DataRewinder<T> {
   ...
   * {@link com.zqy.sutils.glide.load.data.DataRewinder}s.
   *
   * @param <T> The type of data that the {@link com.zqy.sutils.glide.load.data.DataRewinder} will
   *            wrap.
   */
  interface Factory<T> {
    /**
     * Returns a new {@link com.zqy.sutils.glide.load.data.DataRewinder} wrapping the given data.
     */
     ...
     * {@link com.zqy.sutils.glide.load.data.DataRewinder}s for.
     */
