...
import com.zqy.sutils.glide.load.engine.EngineResource.ResourceListener;
...
final class ActiveResources {
  ...
  private ReferenceQueue<com.zqy.sutils.glide.load.engine.EngineResource<?>> resourceReferenceQueue;
  ...
  void activate(Key key, com.zqy.sutils.glide.load.engine.EngineResource<?> resource) {
  ...
  com.zqy.sutils.glide.load.engine.EngineResource<?> get(Key key) {
    ResourceWeakReference activeRef = activeEngineResources.get(key);
    if (activeRef == null) {
      return null;
    }

    com.zqy.sutils.glide.load.engine.EngineResource<?> active = activeRef.get();
    if (active == null) {
  ...
  @Synthetic void cleanupActiveReference( ResourceWeakReference ref) {
    ...
    com.zqy.sutils.glide.load.engine.EngineResource<?> newResource =
        new com.zqy.sutils.glide.load.engine.EngineResource<>(ref.resource, /*isCacheable=*/ true, /*isRecyclable=*/ false);
    newResource.setResourceListener(ref.key, listener);
    listener.onResourceReleased(ref.key, newResource);
  }

  private ReferenceQueue<com.zqy.sutils.glide.load.engine.EngineResource<?>> getReferenceQueue() {
  ...
  @VisibleForTesting
  static final class ResourceWeakReference extends WeakReference<com.zqy.sutils.glide.load.engine.EngineResource<?>> {
    ...
    ResourceWeakReference(
         Key key,
         com.zqy.sutils.glide.load.engine.EngineResource<?> referent,
         ReferenceQueue<? super com.zqy.sutils.glide.load.engine.EngineResource<?>> queue,
