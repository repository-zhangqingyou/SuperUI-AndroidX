...
class DataCacheGenerator implements DataFetcherGenerator,
  ...
  DataCacheGenerator(com.zqy.sutils.glide.load.engine.DecodeHelper<?> helper, FetcherReadyCallback cb) {
  ...
  DataCacheGenerator(List<Key> cacheKeys, com.zqy.sutils.glide.load.engine.DecodeHelper<?> helper, FetcherReadyCallback cb) {
  ...
  public boolean startNext() {
    while (modelLoaders == null || !hasNextModelLoader()) {
      ...
      Key originalKey = new com.zqy.sutils.glide.load.engine.DataCacheKey(sourceId, helper.getSignature());
