...
import com.zqy.sutils.glide.load.engine.DecodeJob.DiskCacheProvider;
...
final class DecodeHelper<Transcode> {
  ...
  private com.zqy.sutils.glide.load.engine.DecodeJob.DiskCacheProvider diskCacheProvider;
  ...
  boolean isResourceEncoderAvailable(com.zqy.sutils.glide.load.engine.Resource<?> resource) {
