...
import com.zqy.sutils.glide.GlideContext;
import com.zqy.sutils.glide.Priority;
import com.zqy.sutils.glide.Registry;
...
import com.zqy.sutils.glide.util.pool.FactoryPools.Poolable;
...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback,
  ...
  private void notifyComplete(com.zqy.sutils.glide.load.engine.Resource<R> resource, DataSource dataSource) {
    setNotifiedOrThrow();
  ...
  private void decodeFromRetrievedData() {
    ...
    com.zqy.sutils.glide.load.engine.Resource<R> resource = null;
    try {
  ...
  private void notifyEncodeAndRelease(com.zqy.sutils.glide.load.engine.Resource<R> resource, DataSource dataSource) {
    if (resource instanceof Initializable) {
      ((Initializable) resource).initialize();
    }

    com.zqy.sutils.glide.load.engine.Resource<R> result = resource;
  ...
  private <Data> com.zqy.sutils.glide.load.engine.Resource<R> decodeFromData(DataFetcher<?> fetcher, Data data,
    ...
    try {
      ...
      com.zqy.sutils.glide.load.engine.Resource<R> result = decodeFromFetcher(data, dataSource);
      if (Log.isLoggable(TAG, Log.VERBOSE)) {
  ...
  private <Data> com.zqy.sutils.glide.load.engine.Resource<R> decodeFromFetcher(Data data, DataSource dataSource)
      throws GlideException {
    com.zqy.sutils.glide.load.engine.LoadPath<Data, ?, R> path = decodeHelper.getLoadPath((Class<Data>) data.getClass());
  ...
  private <Data, ResourceType> com.zqy.sutils.glide.load.engine.Resource<R> runLoadPath(Data data, DataSource dataSource,
  ...
  <Z> com.zqy.sutils.glide.load.engine.Resource<Z> onResourceDecoded(DataSource dataSource,
                                                                    com.zqy.sutils.glide.load.engine.Resource<Z> decoded) {
    @SuppressWarnings("unchecked")
    Class<Z> resourceSubClass = (Class<Z>) decoded.get().getClass();
    Transformation<Z> appliedTransformation = null;
    com.zqy.sutils.glide.load.engine.Resource<Z> transformed = decoded;
    if (dataSource != DataSource.RESOURCE_DISK_CACHE) {
    ...
    com.zqy.sutils.glide.load.engine.Resource<Z> result = transformed;
  ...
  private final class DecodeCallback<Z> implements DecodePath.DecodeCallback<Z> {
    ...
    @Override
    public com.zqy.sutils.glide.load.engine.Resource<Z> onResourceDecoded( com.zqy.sutils.glide.load.engine.Resource<Z> decoded) {
