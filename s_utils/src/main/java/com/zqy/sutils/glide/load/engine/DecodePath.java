...
public class DecodePath<DataType, ResourceType, Transcode> {
  ...
  public com.zqy.sutils.glide.load.engine.Resource<Transcode> decode(DataRewinder<DataType> rewinder, int width, int height,
                                                                    Options options, DecodeCallback<ResourceType> callback) throws GlideException {
    com.zqy.sutils.glide.load.engine.Resource<ResourceType> decoded = decodeResource(rewinder, width, height, options);
    com.zqy.sutils.glide.load.engine.Resource<ResourceType> transformed = callback.onResourceDecoded(decoded);
    return transcoder.transcode(transformed, options);
  }


  private com.zqy.sutils.glide.load.engine.Resource<ResourceType> decodeResource(DataRewinder<DataType> rewinder, int width,
  ...
  private com.zqy.sutils.glide.load.engine.Resource<ResourceType> decodeResourceWithList(DataRewinder<DataType> rewinder, int width,
                                                                                       int height,  Options options, List<Throwable> exceptions) throws GlideException {
    com.zqy.sutils.glide.load.engine.Resource<ResourceType> result = null;
  ...
  interface DecodeCallback<ResourceType> {
    ...
    com.zqy.sutils.glide.load.engine.Resource<ResourceType> onResourceDecoded( Resource<ResourceType> resource);
  }
}
