...
public abstract class DiskCacheStrategy {
   ...
   * {@link com.zqy.sutils.glide.load.data.DataFetcher} and the
   * {@link EncodeStrategy} of the
   * {@link com.zqy.sutils.glide.load.ResourceEncoder} (if an
   * {@link com.zqy.sutils.glide.load.ResourceEncoder} is available).
   */
   ...
   * com.zqy.sutils.glide.load.ResourceEncoder} will use to encode the resource.
   */
