...
import com.zqy.sutils.glide.load.engine.cache.DiskCacheAdapter;
...
public class Engine implements EngineJobListener,
  ...
  private final com.zqy.sutils.glide.load.engine.Jobs jobs;
  ...
  Engine(MemoryCache cache,
      ...
      GlideExecutor sourceUnlimitedExecutor,
      GlideExecutor animationExecutor,
      com.zqy.sutils.glide.load.engine.Jobs jobs,
    ...
    if (jobs == null) {
      jobs = new com.zqy.sutils.glide.load.engine.Jobs();
    }
    this.jobs = jobs;
