...
import com.zqy.sutils.glide.request.ResourceCallback;
 ...
 */
class EngineJob<R> implements com.zqy.sutils.glide.load.engine.DecodeJob.Callback<R>,
    Poolable {
  ...
  private com.zqy.sutils.glide.load.engine.Resource<?> resource;
  ...
  private com.zqy.sutils.glide.load.engine.DecodeJob<R> decodeJob;
  ...
  public void start(com.zqy.sutils.glide.load.engine.DecodeJob<R> decodeJob) {
  ...
  @Override
  public void onResourceReady(com.zqy.sutils.glide.load.engine.Resource<R> resource, DataSource dataSource) {
  ...
  @Override
  public void reschedule(com.zqy.sutils.glide.load.engine.DecodeJob<?> job) {
