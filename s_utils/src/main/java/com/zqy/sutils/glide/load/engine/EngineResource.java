 ...
 * com.zqy.sutils.glide.load.engine.Resource} interface.
 *
 * @param <Z> The type of data returned by the wrapped {@link com.zqy.sutils.glide.load.engine.Resource}.
 */
class EngineResource<Z> implements com.zqy.sutils.glide.load.engine.Resource<Z> {
  ...
  private final com.zqy.sutils.glide.load.engine.Resource<Z> resource;

  interface ResourceListener {
    void onResourceReleased(Key key, EngineResource<?> resource);
  }

  EngineResource(com.zqy.sutils.glide.load.engine.Resource<Z> toWrap, boolean isCacheable, boolean isRecyclable) {
