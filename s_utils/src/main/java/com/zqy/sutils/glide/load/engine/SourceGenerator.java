...
class SourceGenerator implements DataFetcherGenerator,
  ...
  private com.zqy.sutils.glide.load.engine.DataCacheKey originalKey;

  SourceGenerator(com.zqy.sutils.glide.load.engine.DecodeHelper<?> helper, FetcherReadyCallback cb) {
    this.helper = helper;
    this.cb = cb;
  }
  ...
  private void cacheData(Object dataToCache) {
    ...
    try {
      ...
      com.zqy.sutils.glide.load.engine.DataCacheWriter<Object> writer =
          new com.zqy.sutils.glide.load.engine.DataCacheWriter<>(encoder, dataToCache, helper.getOptions());
      originalKey = new com.zqy.sutils.glide.load.engine.DataCacheKey(loadData.sourceKey, helper.getSignature());
