 ...
 * those request.
 */
class AttributeStrategy implements com.zqy.sutils.glide.load.engine.bitmap_recycle.LruPoolStrategy {
  ...
  @VisibleForTesting
  static class Key implements com.zqy.sutils.glide.load.engine.bitmap_recycle.Poolable {
