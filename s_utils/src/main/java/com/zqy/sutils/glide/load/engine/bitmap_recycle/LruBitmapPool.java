...
/**
 * An {@link com.zqy.sutils.glide.load.engine.bitmap_recycle.BitmapPool} implementation that uses an
 * {@link com.zqy.sutils.glide.load.engine.bitmap_recycle.LruPoolStrategy} to bucket {@link Bitmap}s
