...
public class SizeConfigStrategy implements com.zqy.sutils.glide.load.engine.bitmap_recycle.LruPoolStrategy {
  ...
  private final com.zqy.sutils.glide.load.engine.bitmap_recycle.GroupedLinkedMap<Key, Bitmap> groupedMap = new com.zqy.sutils.glide.load.engine.bitmap_recycle.GroupedLinkedMap<>();
  ...
  @VisibleForTesting
  static class KeyPool extends com.zqy.sutils.glide.load.engine.bitmap_recycle.BaseKeyPool<Key> {
  ...
  @VisibleForTesting
  static final class Key implements com.zqy.sutils.glide.load.engine.bitmap_recycle.Poolable {
