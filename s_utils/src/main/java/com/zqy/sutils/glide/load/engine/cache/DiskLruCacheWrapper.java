...
import com.zqy.sutils.glide.disklrucache.DiskLruCache;
import com.zqy.sutils.glide.disklrucache.DiskLruCache.Value;
 ...
 * @see #get(File, long)
 */
public class DiskLruCacheWrapper implements com.zqy.sutils.glide.load.engine.cache.DiskCache {
  ...
  private final com.zqy.sutils.glide.load.engine.cache.SafeKeyGenerator safeKeyGenerator;
  ...
  @Deprecated
  public static synchronized com.zqy.sutils.glide.load.engine.cache.DiskCache get(File directory, long maxSize) {
