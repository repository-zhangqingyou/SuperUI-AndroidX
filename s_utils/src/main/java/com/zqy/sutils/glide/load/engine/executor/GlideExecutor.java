package com.zqy.sutils.glide.load.engine.executor;
...
public final class GlideExecutor implements ExecutorService {
   ...
   * prefix, and the
   * {@link com.zqy.sutils.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy#DEFAULT}
   ...
   * {@link #calculateBestThreadCount()}, the {@link #DEFAULT_DISK_CACHE_EXECUTOR_NAME} thread name
   * prefix, and a custom
   * {@link com.zqy.sutils.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy}
   * uncaught throwable strategy.
   *
   * <p>Disk cache executors do not allow network operations on their threads.
   * @param uncaughtThrowableStrategy The {@link
   * com.zqy.sutils.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy} to use to
   ...
   * and {@link com.zqy.sutils.glide.load.engine.executor.GlideExecutor.UncaughtThrowableStrategy}.
   *
   * <p>Disk cache executors do not allow network operations on their threads.
   *
