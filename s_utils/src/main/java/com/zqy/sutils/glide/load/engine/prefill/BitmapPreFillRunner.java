...
final class BitmapPreFillRunner implements Runnable {
  ...
  private final com.zqy.sutils.glide.load.engine.prefill.PreFillQueue toPrefill;
  private final Clock clock;
  private final Set<com.zqy.sutils.glide.load.engine.prefill.PreFillType> seenTypes = new HashSet<>();
  ...
  public BitmapPreFillRunner(
      BitmapPool bitmapPool, MemoryCache memoryCache, com.zqy.sutils.glide.load.engine.prefill.PreFillQueue allocationOrder) {
    this(
        bitmapPool,
        memoryCache,
        allocationOrder,
  ...
  BitmapPreFillRunner(
      ...
      com.zqy.sutils.glide.load.engine.prefill.PreFillQueue allocationOrder,
      Clock clock,
      Handler handler) {
