...
final class PreFillQueue {
  ...
  private final Map<com.zqy.sutils.glide.load.engine.prefill.PreFillType, Integer> bitmapsPerType;
  private final List<com.zqy.sutils.glide.load.engine.prefill.PreFillType> keyList;
  private int bitmapsRemaining;
  private int keyIndex;

  public PreFillQueue(Map<com.zqy.sutils.glide.load.engine.prefill.PreFillType, Integer> bitmapsPerType) {
  ...
  public com.zqy.sutils.glide.load.engine.prefill.PreFillType remove() {
