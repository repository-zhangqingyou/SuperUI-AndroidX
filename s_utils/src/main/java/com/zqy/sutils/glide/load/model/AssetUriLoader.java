...
import com.zqy.sutils.glide.load.data.FileDescriptorAssetPathFetcher;
import com.zqy.sutils.glide.load.data.StreamAssetPathFetcher;
 ...
 */
public class AssetUriLoader<Data> implements com.zqy.sutils.glide.load.model.ModelLoader<Uri, Data> {
  ...
  public static class StreamFactory implements ModelLoaderFactory<Uri, InputStream>,
    ...
    @Override
    public com.zqy.sutils.glide.load.model.ModelLoader<Uri, InputStream> build(MultiModelLoaderFactory multiFactory) {
