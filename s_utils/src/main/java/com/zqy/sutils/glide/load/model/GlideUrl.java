 ...
 *
 * <p> This class can also optionally wrap {@link com.zqy.sutils.glide.load.model.Headers} for
 * convenience. </p>
 */
public class GlideUrl implements Key {
  private static final String ALLOWED_URI_CHARS = "@#&=*+-_.,:!?()/~'%;$";
  private final com.zqy.sutils.glide.load.model.Headers headers;
  ...
  public GlideUrl(URL url) {
    this(url, com.zqy.sutils.glide.load.model.Headers.DEFAULT);
  }
  ...
  public GlideUrl(URL url, com.zqy.sutils.glide.load.model.Headers headers) {
