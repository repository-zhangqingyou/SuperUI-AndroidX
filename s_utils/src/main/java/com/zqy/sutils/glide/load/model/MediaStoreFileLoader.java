 ...
 */
public final class MediaStoreFileLoader implements com.zqy.sutils.glide.load.model.ModelLoader<Uri, File> {
  ...
  /**
   * {@link com.zqy.sutils.glide.load.model.ModelLoaderFactory} for {@link MediaStoreFileLoader}s.
   */
