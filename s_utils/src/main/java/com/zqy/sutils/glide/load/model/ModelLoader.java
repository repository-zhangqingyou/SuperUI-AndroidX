 ...
 * {@link com.zqy.sutils.glide.load.ResourceDecoder} to decode a resource.
 */
public interface ModelLoader<Model, Data> {
  ...
  /**
   * Returns a {@link com.zqy.sutils.glide.load.model.ModelLoader.LoadData} containing a
   ...
   *               {@link com.zqy.sutils.glide.request.target.Target#SIZE_ORIGINAL} to indicate that
