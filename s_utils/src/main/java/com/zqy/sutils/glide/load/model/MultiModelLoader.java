...
import com.zqy.sutils.glide.load.data.DataFetcher.DataCallback;
 ...
 * com.zqy.sutils.glide.load.engine.DataFetcherGenerator} implementations and should try to avoid this
 * duplication. </p>
 */
class MultiModelLoader<Model, Data> implements com.zqy.sutils.glide.load.model.ModelLoader<Model, Data> {

  private final List<com.zqy.sutils.glide.load.model.ModelLoader<Model, Data>> modelLoaders;
  private final Pool<List<Throwable>> exceptionListPool;

  MultiModelLoader( List<com.zqy.sutils.glide.load.model.ModelLoader<Model, Data>> modelLoaders,
  ...
  public LoadData<Data> buildLoadData( Model model, int width, int height,
    ...
    for (int i = 0; i < size; i++) {
      com.zqy.sutils.glide.load.model.ModelLoader<Model, Data> modelLoader = modelLoaders.get(i);
  ...
  static class MultiFetcher<Data> implements DataFetcher<Data>, DataCallback<Data> {
    ...
    public void loadData(
         Priority priority,  DataCallback<? super Data> callback) {
