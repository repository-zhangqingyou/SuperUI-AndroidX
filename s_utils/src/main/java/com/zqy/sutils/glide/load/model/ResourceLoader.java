 ...
 */
public class ResourceLoader<Data> implements com.zqy.sutils.glide.load.model.ModelLoader<Integer, Data> {
  ...
  public ResourceLoader(Resources resources, com.zqy.sutils.glide.load.model.ModelLoader<Uri, Data> uriLoader) {
  ...
  public static class StreamFactory implements ModelLoaderFactory<Integer, InputStream> {
    ...
    @Override
    public com.zqy.sutils.glide.load.model.ModelLoader<Integer, InputStream> build(MultiModelLoaderFactory multiFactory) {
  ...
  public static class FileDescriptorFactory
    ...
    @Override
    public com.zqy.sutils.glide.load.model.ModelLoader<Integer, ParcelFileDescriptor> build(MultiModelLoaderFactory multiFactory) {
  ...
  public static final class AssetFileDescriptorFactory
    ...
    @Override
    public com.zqy.sutils.glide.load.model.ModelLoader<Integer, AssetFileDescriptor> build(MultiModelLoaderFactory multiFactory) {
      return new ResourceLoader<>(
