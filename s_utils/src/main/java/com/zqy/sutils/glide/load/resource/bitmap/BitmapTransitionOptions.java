...
import com.zqy.sutils.glide.TransitionOptions;
import com.zqy.sutils.glide.request.transition.BitmapTransitionFactory;
import com.zqy.sutils.glide.request.transition.DrawableCrossFadeFactory;
...
public final class BitmapTransitionOptions extends
   ...
   *
   * @see com.zqy.sutils.glide.GenericTransitionOptions#with(TransitionFactory)
   */
