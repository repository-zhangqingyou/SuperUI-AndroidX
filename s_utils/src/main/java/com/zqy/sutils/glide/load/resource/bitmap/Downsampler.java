...
import com.zqy.sutils.glide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
...
public final class Downsampler {
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT = Option.memory(
      "com.zqy.sutils.glide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  /**
  ...
  public static final Option<Boolean> FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS =
      Option.memory("com.zqy.sutils.glide.load.resource.bitmap.Downsampler.FixBitmapSize", false);
