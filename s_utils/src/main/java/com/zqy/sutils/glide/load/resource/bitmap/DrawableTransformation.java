 ...
 * {@link com.zqy.sutils.glide.request.target.Target#SIZE_ORIGINAL}. {@link Drawable}s without
...
public class DrawableTransformation implements Transformation<Drawable> {
  ...
  @Override
  public Resource<Drawable> transform( Context context,
       Resource<Drawable> resource, int outWidth, int outHeight) {
