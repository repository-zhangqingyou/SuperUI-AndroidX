...
import com.zqy.sutils.glide.util.ExceptionCatchingInputStream;
import com.zqy.sutils.glide.util.MarkEnforcingInputStream;
...
public class StreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {
  ...
  public StreamBitmapDecoder(com.zqy.sutils.glide.load.resource.bitmap.Downsampler downsampler, ArrayPool byteArrayPool) {
