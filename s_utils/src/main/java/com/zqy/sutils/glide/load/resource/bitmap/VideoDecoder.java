...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
  ...
  public static final Option<Long> TARGET_FRAME = Option.disk(
      "com.zqy.sutils.glide.load.resource.bitmap.VideoBitmapDecode.TargetFrame", DEFAULT_FRAME,
  ...
  public static final Option<Integer> FRAME_OPTION = Option.disk(
      "com.zqy.sutils.glide.load.resource.bitmap.VideoBitmapDecode.FrameOption",
  ...
  public Resource<Bitmap> decode(
       T resource, int outWidth, int outHeight,  Options options)
      throws IOException {
