...
public final class DrawableDecoderCompat {
   ...
   */
  public static Drawable getDrawable(
      Context ourContext, @DrawableRes int id, Theme theme) {
    return getDrawable(ourContext, ourContext, id, theme);
  }

  private static Drawable getDrawable(
      Context ourContext, Context targetContext, @DrawableRes int id, Theme theme) {
    try {
  ...
  private static Drawable loadDrawableV4(
      Context context, @DrawableRes int id, Theme theme) {
