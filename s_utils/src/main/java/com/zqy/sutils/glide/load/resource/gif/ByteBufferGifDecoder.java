...
import com.zqy.sutils.glide.gifdecoder.GifHeader;
import com.zqy.sutils.glide.gifdecoder.GifHeaderParser;
import com.zqy.sutils.glide.gifdecoder.StandardGifDecoder;
...
import com.zqy.sutils.glide.load.resource.UnitTransformation;
 ...
 * com.zqy.sutils.glide.load.resource.gif.GifDrawable} from {@link java.io.InputStream} data.
 */
public class ByteBufferGifDecoder implements ResourceDecoder<ByteBuffer, com.zqy.sutils.glide.load.resource.gif.GifDrawable> {
  ...
  private final com.zqy.sutils.glide.load.resource.gif.GifBitmapProvider provider;
  ...
  public boolean handles( ByteBuffer source,  Options options) throws IOException {
    return !options.get(com.zqy.sutils.glide.load.resource.gif.GifOptions.DISABLE_ANIMATION)
        && ImageHeaderParserUtils.getType(parsers, source) == ImageType.GIF;
  }

  @Override
  public com.zqy.sutils.glide.load.resource.gif.GifDrawableResource decode( ByteBuffer source, int width, int height,
                                                                          Options options) {
  ...
  private com.zqy.sutils.glide.load.resource.gif.GifDrawableResource decode(
    ...
    try {
      ...
      com.zqy.sutils.glide.load.resource.gif.GifDrawable gifDrawable =
