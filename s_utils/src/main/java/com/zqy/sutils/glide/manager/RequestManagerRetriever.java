...
public class RequestManagerRetriever implements Handler.Callback {
  @VisibleForTesting
  static final String FRAGMENT_TAG = "com.zqy.sutils.glide.manager";
  ...
  @VisibleForTesting
  final Map<android.app.FragmentManager, com.zqy.sutils.glide.manager.RequestManagerFragment> pendingRequestManagerFragments =
      new HashMap<>();
      ...
      synchronized (this) {
        if (applicationManager == null) {
          ...
          applicationManager =
              factory.build(
                  glide,
                  new com.zqy.sutils.glide.manager.ApplicationLifecycle(),
  ...
  private static void findAllSupportFragmentsWithViews(
      Collection<Fragment> topLevelFragments,
  ...
  com.zqy.sutils.glide.manager.RequestManagerFragment getRequestManagerFragment(Activity activity) {
  ...
  private com.zqy.sutils.glide.manager.RequestManagerFragment getRequestManagerFragment(
       final android.app.FragmentManager fm,
      android.app.Fragment parentHint,
      boolean isParentVisible) {
    com.zqy.sutils.glide.manager.RequestManagerFragment current = (com.zqy.sutils.glide.manager.RequestManagerFragment) fm.findFragmentByTag(FRAGMENT_TAG);
    if (current == null) {
      current = pendingRequestManagerFragments.get(fm);
      if (current == null) {
        current = new com.zqy.sutils.glide.manager.RequestManagerFragment();
  ...
  public interface RequestManagerFactory {
    ...
    RequestManager build(
             Glide glide,
             com.zqy.sutils.glide.manager.Lifecycle lifecycle,
             com.zqy.sutils.glide.manager.RequestManagerTreeNode requestManagerTreeNode,
             Context context);
  }
