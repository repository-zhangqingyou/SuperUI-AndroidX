 ...
 * {@link com.zqy.sutils.glide.GlideBuilder} and registering
 * {@link com.zqy.sutils.glide.load.model.ModelLoader ModelLoaders}.
 *
 * <p> To use this interface: <ol> <li> Implement the GlideModule interface in a class with public
 * visibility, calling
 * {@link Registry#prepend(Class, Class, com.zqy.sutils.glide.load.ResourceDecoder)} for each
 * {@link com.zqy.sutils.glide.load.model.ModelLoader} you'd like to register:
 * <pre>
 *                  <code>
 ...
 *                 {@code
 *                      <meta-data
 *                          android:name="com.zqy.sutils.glide.samples.flickr.FlickrGlideModule"
