...
public class RequestFutureTarget<R> implements FutureTarget<R>,
  ...
  private R resource;
  private com.zqy.sutils.glide.request.Request request;
  ...
  @Override
  public void setRequest(@Nullable com.zqy.sutils.glide.request.Request request) {
  ...
  public synchronized boolean onLoadFailed(
      GlideException e, Object model, Target<R> target, boolean isFirstResource) {
    loadFailed = true;
    exception = e;
    waiter.notifyAll(this);
    return false;
