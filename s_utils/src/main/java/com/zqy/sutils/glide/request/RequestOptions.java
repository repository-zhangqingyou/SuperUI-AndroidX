...
import com.zqy.sutils.glide.load.MultiTransformation;
...
import com.zqy.sutils.glide.load.resource.bitmap.CenterCrop;
import com.zqy.sutils.glide.load.resource.bitmap.CenterInside;
import com.zqy.sutils.glide.load.resource.bitmap.CircleCrop;
import com.zqy.sutils.glide.load.resource.bitmap.DownsampleStrategy;
import com.zqy.sutils.glide.load.resource.bitmap.Downsampler;
import com.zqy.sutils.glide.load.resource.bitmap.DrawableTransformation;
import com.zqy.sutils.glide.load.resource.bitmap.FitCenter;
import com.zqy.sutils.glide.load.resource.bitmap.VideoDecoder;
import com.zqy.sutils.glide.load.resource.gif.GifDrawable;
import com.zqy.sutils.glide.load.resource.gif.GifDrawableTransformation;
import com.zqy.sutils.glide.load.resource.gif.GifOptions;
import com.zqy.sutils.glide.signature.EmptySignature;
...
public class RequestOptions implements Cloneable {
  ...
  /**
   * Returns a {@link com.zqy.sutils.glide.request.RequestOptions} with {@link
  ...
  /**
   * Returns a new {@link com.zqy.sutils.glide.request.RequestOptions} with {@link #dontAnimate()}
   * called.
   */
  @SuppressWarnings("WeakerAccess") // Public API
  ...
  /**
   * Applies a multiplier to the {@link com.zqy.sutils.glide.request.target.Target}'s size before
   ...
   *                       {@link com.zqy.sutils.glide.request.target.Target}'s dimensions when
   ...
   * {@link com.zqy.sutils.glide.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link com.zqy.sutils.glide.request.target.Target}'s width and height with the
   ...
   * @return This request builder.
   * @see com.zqy.sutils.glide.signature.ObjectKey
   */
  ...
  private RequestOptions transform(
       Transformation<Bitmap> transformation, boolean isRequired) {
    if (isAutoCloneEnabled) {
   ...
   * {@link com.zqy.sutils.glide.TransitionOptions#dontTransition()}</p>
   */
  // Guaranteed to modify the current object by the isAutoCloneEnabledCheck.
  @SuppressWarnings("CheckResult")
