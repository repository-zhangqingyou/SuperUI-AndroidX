...
import com.zqy.sutils.glide.load.resource.drawable.DrawableDecoderCompat;
import com.zqy.sutils.glide.request.target.SizeReadyCallback;
import com.zqy.sutils.glide.request.target.Target;
import com.zqy.sutils.glide.request.transition.Transition;
import com.zqy.sutils.glide.request.transition.TransitionFactory;
...
/**
 * A {@link com.zqy.sutils.glide.request.Request} that loads a {@link Resource} into a given
 * {@link Target}.
 *
 * @param <R> The type of the resource that will be transcoded from the loaded resource.
 */
public final class SingleRequest<R> implements com.zqy.sutils.glide.request.Request,
    SizeReadyCallback,
        ResourceCallback,
