...
/**
 * A coordinator that coordinates two individual {@link com.zqy.sutils.glide.request.Request}s that load a small thumbnail
 * version of an image and the full size version of the image at the same time.
 */
public class ThumbnailRequestCoordinator implements com.zqy.sutils.glide.request.RequestCoordinator,
        com.zqy.sutils.glide.request.Request {
  private final com.zqy.sutils.glide.request.RequestCoordinator parent;

  private com.zqy.sutils.glide.request.Request full;
  private com.zqy.sutils.glide.request.Request thumb;
  ...
  public void setRequests(com.zqy.sutils.glide.request.Request full, com.zqy.sutils.glide.request.Request thumb) {
    this.full = full;
    this.thumb = thumb;
  }
  ...
  @Override
  public void onRequestFailed(com.zqy.sutils.glide.request.Request request) {
