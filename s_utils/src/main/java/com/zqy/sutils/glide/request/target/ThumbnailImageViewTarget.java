 ...
 * com.zqy.sutils.glide.RequestBuilder#thumbnail(com.zqy.sutils.glide.RequestBuilder)} API into views in
 * a scrolling list like ListView, GridView, or RecyclerView.
 *
 * <p>{@link com.zqy.sutils.glide.request.target.FixedSizeDrawable} may cause skewing or other undesirable behavior depending on
