...
/**
 * A {@link com.zqy.sutils.glide.request.transition.TransitionFactory} for complex types that have a {@link Bitmap} inside.
 ...
 *            be transitioned.
 */
public abstract class BitmapContainerTransitionFactory<R> implements com.zqy.sutils.glide.request.transition.TransitionFactory<R> {
  private final com.zqy.sutils.glide.request.transition.TransitionFactory<Drawable> realFactory;
  ...
  public com.zqy.sutils.glide.request.transition.Transition<R> build(DataSource dataSource, boolean isFirstResource) {
    com.zqy.sutils.glide.request.transition.Transition<Drawable> transition = realFactory.build(dataSource, isFirstResource);
  ...
  private final class BitmapGlideAnimation implements com.zqy.sutils.glide.request.transition.Transition<R> {
    private final com.zqy.sutils.glide.request.transition.Transition<Drawable> transition;
