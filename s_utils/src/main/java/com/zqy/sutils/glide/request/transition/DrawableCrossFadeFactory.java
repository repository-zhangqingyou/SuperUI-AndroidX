...
/**
 * A factory class that produces a new {@link com.zqy.sutils.glide.request.transition.Transition} that varies depending on whether or not
 ...
 * the memory cache this factory produces an {@link com.zqy.sutils.glide.request.transition.NoTransition}.
 */
// Public API.
...
public class DrawableCrossFadeFactory implements TransitionFactory<Drawable> {
  ...
  @Override
  public com.zqy.sutils.glide.request.transition.Transition<Drawable> build(DataSource dataSource, boolean isFirstResource) {
