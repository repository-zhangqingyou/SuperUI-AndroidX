...
public final class SPStaticUtils {
    ...
    private static com.zqy.sdk.utilcode.util.SPUtils sDefaultSPUtils;

    /**
     * Set the default instance of {@link com.zqy.sdk.utilcode.util.SPUtils}.
     *
     * @param spUtils The default instance of {@link com.zqy.sdk.utilcode.util.SPUtils}.
     */
    public static void setDefaultSPUtils(final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
     ...
     * @param key     The key of sp.
     * @param value   The value of sp.
     * @param spUtils The instance of {@link com.zqy.sdk.utilcode.util.SPUtils}.
     */
    public static void put(@NonNull final String key, final String value, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
    ...
    public static void put(@NonNull final String key,
                           final String value,
                           final boolean isCommit,
                           @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
     ...
     * @return the string value if sp exists or {@code ""} otherwise
     */
    public static String getString(@NonNull final String key, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
     ...
     * @param spUtils The instance of {@link com.zqy.sdk.utilcode.util.SPUtils}.
     */
    public static void put(@NonNull final String key, final int value, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
        spUtils.put(key, value);
    }
     ...
     * @return the int value if sp exists or {@code -1} otherwise
     */
    public static int getInt(@NonNull final String key, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
     ...
     * @return the int value if sp exists or {@code defaultValue} otherwise
     */
    public static int getInt(@NonNull final String key, final int defaultValue, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
     ...
     * @param spUtils The instance of {@link com.zqy.sdk.utilcode.util.SPUtils}.
     */
    public static void put(@NonNull final String key, final long value, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
        spUtils.put(key, value);
    }
     ...
     * @return the long value if sp exists or {@code -1} otherwise
     */
    public static long getLong(@NonNull final String key, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
     ...
     * @return the long value if sp exists or {@code defaultValue} otherwise
     */
    public static long getLong(@NonNull final String key, final long defaultValue, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
     ...
     * @param spUtils The instance of {@link com.zqy.sdk.utilcode.util.SPUtils}.
     */
    public static void put(@NonNull final String key, final float value, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
        spUtils.put(key, value);
    }
     ...
     * @return the float value if sp exists or {@code -1f} otherwise
     */
    public static float getFloat(@NonNull final String key, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
     ...
     * @return the float value if sp exists or {@code defaultValue} otherwise
     */
    public static float getFloat(@NonNull final String key, final float defaultValue, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
     ...
     * @param spUtils The instance of {@link com.zqy.sdk.utilcode.util.SPUtils}.
     */
    public static void put(@NonNull final String key, final boolean value, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
        spUtils.put(key, value);
    }
     ...
     * @return the boolean value if sp exists or {@code false} otherwise
     */
    public static boolean getBoolean(@NonNull final String key, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
     ...
     * @param spUtils The instance of {@link com.zqy.sdk.utilcode.util.SPUtils}.
     */
    public static void put(@NonNull final String key, final Set<String> value, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
        spUtils.put(key, value);
    }
     ...
     * or {@code Collections.<String>emptySet()} otherwise
     */
    public static Set<String> getStringSet(@NonNull final String key, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
     ...
     * @return all values in sp
     */
    public static Map<String, ?> getAll(@NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
     ...
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean contains(@NonNull final String key, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
     ...
     * @param spUtils The instance of {@link com.zqy.sdk.utilcode.util.SPUtils}.
     */
    public static void remove(@NonNull final String key, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
        spUtils.remove(key);
    }
     ...
     * @param spUtils  The instance of {@link com.zqy.sdk.utilcode.util.SPUtils}.
     */
    public static void remove(@NonNull final String key, final boolean isCommit, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
     ...
     * @param spUtils The instance of {@link com.zqy.sdk.utilcode.util.SPUtils}.
     */
    public static void clear(@NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
        spUtils.clear();
    }
     ...
     * @param spUtils  The instance of {@link com.zqy.sdk.utilcode.util.SPUtils}.
     */
    public static void clear(final boolean isCommit, @NonNull final com.zqy.sdk.utilcode.util.SPUtils spUtils) {
        spUtils.clear(isCommit);
    }

    private static com.zqy.sdk.utilcode.util.SPUtils getDefaultSPUtils() {
