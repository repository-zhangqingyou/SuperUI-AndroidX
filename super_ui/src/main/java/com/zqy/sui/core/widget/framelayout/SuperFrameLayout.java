package com.zqy.sui.core.widget.framelayout;
...
public class SuperFrameLayout extends FrameLayout implements DrawableImpl {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        attrMap.put(SuperAttr.填充颜色, typedArray == null ? Color.TRANSPARENT : typedArray.getColor(R.styleable.SuperFrameLayout_zqy_solid_color, Color.TRANSPARENT));
        attrMap.put(SuperAttr.边框颜色, typedArray == null ? Color.TRANSPARENT : typedArray.getColor(R.styleable.SuperFrameLayout_zqy_stroke_color, Color.TRANSPARENT));
        attrMap.put(SuperAttr.渐变开始颜色, typedArray == null ? Color.TRANSPARENT : typedArray.getColor(R.styleable.SuperFrameLayout_zqy_start_color, Color.TRANSPARENT));
        attrMap.put(SuperAttr.渐变结束颜色, typedArray == null ? Color.TRANSPARENT : typedArray.getColor(R.styleable.SuperFrameLayout_zqy_end_color, Color.TRANSPARENT));
        attrMap.put(SuperAttr.按下时填充颜色, typedArray == null ? Color.TRANSPARENT : typedArray.getColor(R.styleable.SuperFrameLayout_zqy_click_solid_color, Color.TRANSPARENT));
        attrMap.put(SuperAttr.按下时边框颜色, typedArray == null ? Color.TRANSPARENT : typedArray.getColor(R.styleable.SuperFrameLayout_zqy_click_stroke_color, Color.TRANSPARENT));
        attrMap.put(SuperAttr.字体颜色, typedArray == null ? Color.GRAY : typedArray.getColor(R.styleable.SuperFrameLayout_zqy_text_color, Color.GRAY));
        attrMap.put(SuperAttr.按下时字体颜色, typedArray == null ? Color.TRANSPARENT : typedArray.getColor(R.styleable.SuperFrameLayout_zqy_click_text_color, Color.TRANSPARENT));
        attrMap.put(SuperAttr.渐变模式, typedArray == null ? Gradient.LINEAR_GRADIENT.ordinal() : typedArray.getInt(R.styleable.SuperFrameLayout_zqy_gradient, Gradient.LINEAR_GRADIENT.ordinal()));//默认 线性梯度(线性渐变)
        attrMap.put(SuperAttr.渐变方向, typedArray == null ? GradientDrawable.Orientation.LEFT_RIGHT.ordinal() : typedArray.getInt(R.styleable.SuperFrameLayout_zqy_orientation, GradientDrawable.Orientation.LEFT_RIGHT.ordinal()));//默认从左到右
        attrMap.put(SuperAttr.边框宽度, typedArray == null ? 0 : typedArray.getDimensionPixelSize(R.styleable.SuperFrameLayout_zqy_stroke_width, 0));
        attrMap.put(SuperAttr.四圆角, typedArray == null ? SizeUtils.dp2px(5) : typedArray.getDimensionPixelSize(R.styleable.SuperFrameLayout_zqy_radius, SizeUtils.dp2px(5)));//默认圆角5dp
        attrMap.put(SuperAttr.左上圆角, typedArray == null ? 0 : typedArray.getDimensionPixelSize(R.styleable.SuperFrameLayout_zqy_top_left_radius, 0));
        attrMap.put(SuperAttr.右上圆角, typedArray == null ? 0 : typedArray.getDimensionPixelSize(R.styleable.SuperFrameLayout_zqy_top_right_radius, 0));
        attrMap.put(SuperAttr.左下圆角, typedArray == null ? 0 : typedArray.getDimensionPixelSize(R.styleable.SuperFrameLayout_zqy_bottom_left_radius, 0));
        attrMap.put(SuperAttr.右下圆角, typedArray == null ? 0 : typedArray.getDimensionPixelSize(R.styleable.SuperFrameLayout_zqy_bottom_right_radius, 0));
        typedArray.recycle();
