...
public class TextTipsDialog extends BaseDialog {
    ...
    public Object getLayout() {
        return R.layout.sui_tips_dialog;
    }
    ...
    public void initData() {
        setDialogRadiusColos(5, R.color.sui_white);
        mTvButton1.setTextSize(18);
        mTvButton2.setTextSize(18);
        mTvButton1.setTextColor(ContextCompat.getColor(getContext(), R.color.sui_black_light1));
        mTvButton1.setClickAlpha(0.5f);
        mTvButton2.setTextColor(ContextCompat.getColor(getContext(), R.color.sui_red_light));
