...
public class SuperTextView extends AppCompatTextView implements DrawableImpl {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            是否有按下效果 = typedArray.getBoolean(R.styleable.SuperTextView_zqy_click_effect, true);//默认有点击效果
            按下时透明度 = typedArray.getFloat(R.styleable.SuperTextView_zqy_click_alpha, 0.7f);//默认点击透明度
            填充颜色 = typedArray.getColor(R.styleable.SuperTextView_zqy_solid_color, Color.TRANSPARENT);
            边框颜色 = typedArray.getColor(R.styleable.SuperTextView_zqy_stroke_color, Color.TRANSPARENT);
            渐变开始颜色 = typedArray.getColor(R.styleable.SuperTextView_zqy_start_color, Color.TRANSPARENT);
            渐变结束颜色 = typedArray.getColor(R.styleable.SuperTextView_zqy_end_color, Color.TRANSPARENT);
            按下时填充颜色 = typedArray.getColor(R.styleable.SuperTextView_zqy_click_solid_color, Color.TRANSPARENT);
            ...
            右上圆角 = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_zqy_top_right_radius, 0);
            左下圆角 = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_zqy_bottom_left_radius, 0);
            右下圆角 = typedArray.getDimensionPixelSize(R.styleable.SuperTextView_zqy_bottom_right_radius, 0);
            typedArray.recycle();
        }
