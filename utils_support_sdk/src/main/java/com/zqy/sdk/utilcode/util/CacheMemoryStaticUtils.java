...
public final class CacheMemoryStaticUtils {
    ...
    private static com.zqy.sdk.utilcode.util.CacheMemoryUtils sDefaultCacheMemoryUtils;

    /**
     * Set the default instance of {@link com.zqy.sdk.utilcode.util.CacheMemoryUtils}.
     *
     * @param cacheMemoryUtils The default instance of {@link com.zqy.sdk.utilcode.util.CacheMemoryUtils}.
     */
    public static void setDefaultCacheMemoryUtils(final com.zqy.sdk.utilcode.util.CacheMemoryUtils cacheMemoryUtils) {
     ...
     * @param key              The key of cache.
     * @param value            The value of cache.
     * @param cacheMemoryUtils The instance of {@link com.zqy.sdk.utilcode.util.CacheMemoryUtils}.
     */
    public static void put(@NonNull final String key,
                           final Object value,
                           @NonNull final com.zqy.sdk.utilcode.util.CacheMemoryUtils cacheMemoryUtils) {
     ...
     * @return the value if cache exists or null otherwise
     */
    public static <T> T get(@NonNull final String key, @NonNull final com.zqy.sdk.utilcode.util.CacheMemoryUtils cacheMemoryUtils) {
     ...
     * @return the count of cache
     */
    public static int getCacheCount(@NonNull final com.zqy.sdk.utilcode.util.CacheMemoryUtils cacheMemoryUtils) {
     ...
     * @return {@code true}: success<br>{@code false}: fail
     */
    public static Object remove(@NonNull final String key, @NonNull final com.zqy.sdk.utilcode.util.CacheMemoryUtils cacheMemoryUtils) {
     ...
     * @param cacheMemoryUtils The instance of {@link com.zqy.sdk.utilcode.util.CacheMemoryUtils}.
     */
    public static void clear(@NonNull final com.zqy.sdk.utilcode.util.CacheMemoryUtils cacheMemoryUtils) {
        cacheMemoryUtils.clear();
    }

    private static com.zqy.sdk.utilcode.util.CacheMemoryUtils getDefaultCacheMemoryUtils() {
