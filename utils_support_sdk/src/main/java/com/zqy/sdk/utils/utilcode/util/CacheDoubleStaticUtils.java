...
public final class CacheDoubleStaticUtils {
    ...
    private static com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils sDefaultCacheDoubleUtils;

    /**
     * Set the default instance of {@link com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils}.
     *
     * @param cacheDoubleUtils The default instance of {@link com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils}.
     */
    public static void setDefaultCacheDoubleUtils(final com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils cacheDoubleUtils) {
     ...
     * @param key              The key of cache.
     * @param value            The value of cache.
     * @param cacheDoubleUtils The instance of {@link com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils}.
     */
    public static void put(@NonNull final String key,
                           final byte[] value,
                           @NonNull final com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the bytes if cache exists or null otherwise
     */
    public static byte[] getBytes(@NonNull final String key, @NonNull final com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the string value if cache exists or null otherwise
     */
    public static String getString(@NonNull final String key, @NonNull final com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the JSONArray if cache exists or null otherwise
     */
    public static JSONArray getJSONArray(@NonNull final String key, @NonNull final com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the bitmap if cache exists or null otherwise
     */
    public static Bitmap getBitmap(@NonNull final String key, @NonNull final com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the drawable if cache exists or null otherwise
     */
    public static Drawable getDrawable(@NonNull final String key, @NonNull final com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the bitmap if cache exists or null otherwise
     */
    public static Object getSerializable(@NonNull final String key, @NonNull final com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the size of cache in disk
     */
    public static long getCacheDiskSize(@NonNull final com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the count of cache in disk
     */
    public static int getCacheDiskCount(@NonNull final com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the count of cache in memory.
     */
    public static int getCacheMemoryCount(@NonNull final com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils cacheDoubleUtils) {
     ...
     * @param cacheDoubleUtils The instance of {@link com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils}.
     */
    public static void remove(@NonNull String key, @NonNull final com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils cacheDoubleUtils) {
     ...
     * @param cacheDoubleUtils The instance of {@link com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils}.
     */
    public static void clear(@NonNull final com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils cacheDoubleUtils) {
        cacheDoubleUtils.clear();
    }

    private static com.zqy.sdk.utils.utilcode.util.CacheDoubleUtils getDefaultCacheDoubleUtils() {
