...
import static com.zqy.sdk.utils.virtual.CheckResult.RESULT_EMULATOR;
import static com.zqy.sdk.utils.virtual.CheckResult.RESULT_MAYBE_EMULATOR;
import static com.zqy.sdk.utils.virtual.CheckResult.RESULT_UNKNOWN;
...
public class EmulatorCheckUtil {
    ...
    public boolean readSysProperty(Context context, EmulatorCheckCallback callback) {
        ...
        //检测硬件名称
        com.zqy.sdk.utils.virtual.CheckResult hardwareResult = checkFeaturesByHardware();
        ...
        //检测渠道
        com.zqy.sdk.utils.virtual.CheckResult flavorResult = checkFeaturesByFlavor();
        ...
        //检测设备型号
        com.zqy.sdk.utils.virtual.CheckResult modelResult = checkFeaturesByModel();
        ...
        //检测硬件制造商
        com.zqy.sdk.utils.virtual.CheckResult manufacturerResult = checkFeaturesByManufacturer();
        ...
        //检测主板名称
        com.zqy.sdk.utils.virtual.CheckResult boardResult = checkFeaturesByBoard();
        ...
        //检测主板平台
        com.zqy.sdk.utils.virtual.CheckResult platformResult = checkFeaturesByPlatform();
        ...
        //检测基带信息
        com.zqy.sdk.utils.virtual.CheckResult baseBandResult = checkFeaturesByBaseBand();
        ...
        //检测进程组信息
        com.zqy.sdk.utils.virtual.CheckResult cgroupResult = checkFeaturesByCgroup();
    ...
    private String getProperty(String propName) {
        String property = com.zqy.sdk.utils.virtual.CommandUtil.getSingleInstance().getProperty(propName);
     ...
     */
    private com.zqy.sdk.utils.virtual.CheckResult checkFeaturesByHardware() {
        String hardware = getProperty("ro.hardware");
        if (null == hardware) return new com.zqy.sdk.utils.virtual.CheckResult(RESULT_MAYBE_EMULATOR, null);
        int result;
        ...
        return new com.zqy.sdk.utils.virtual.CheckResult(result, hardware);
    }
     ...
     * @return 0表示可能是模拟器，1表示模拟器，2表示可能是真机
     */
    private com.zqy.sdk.utils.virtual.CheckResult checkFeaturesByFlavor() {
        String flavor = getProperty("ro.build.flavor");
        if (null == flavor) return new com.zqy.sdk.utils.virtual.CheckResult(RESULT_MAYBE_EMULATOR, null);
        int result;
        ...
        return new com.zqy.sdk.utils.virtual.CheckResult(result, flavor);
    }
     ...
     * @return 0表示可能是模拟器，1表示模拟器，2表示可能是真机
     */
    private com.zqy.sdk.utils.virtual.CheckResult checkFeaturesByModel() {
        String model = getProperty("ro.product.model");
        if (null == model) return new com.zqy.sdk.utils.virtual.CheckResult(RESULT_MAYBE_EMULATOR, null);
        int result;
        ...
        return new com.zqy.sdk.utils.virtual.CheckResult(result, model);
    }
     ...
     * @return 0表示可能是模拟器，1表示模拟器，2表示可能是真机
     */
    private com.zqy.sdk.utils.virtual.CheckResult checkFeaturesByManufacturer() {
        String manufacturer = getProperty("ro.product.manufacturer");
        if (null == manufacturer) return new com.zqy.sdk.utils.virtual.CheckResult(RESULT_MAYBE_EMULATOR, null);
        int result;
        ...
        return new com.zqy.sdk.utils.virtual.CheckResult(result, manufacturer);
    }
     ...
     * @return 0表示可能是模拟器，1表示模拟器，2表示可能是真机
     */
    private com.zqy.sdk.utils.virtual.CheckResult checkFeaturesByBoard() {
        String board = getProperty("ro.product.board");
        if (null == board) return new com.zqy.sdk.utils.virtual.CheckResult(RESULT_MAYBE_EMULATOR, null);
        int result;
        ...
        return new com.zqy.sdk.utils.virtual.CheckResult(result, board);
    }
     ...
     * @return 0表示可能是模拟器，1表示模拟器，2表示可能是真机
     */
    private com.zqy.sdk.utils.virtual.CheckResult checkFeaturesByPlatform() {
        String platform = getProperty("ro.board.platform");
        if (null == platform) return new com.zqy.sdk.utils.virtual.CheckResult(RESULT_MAYBE_EMULATOR, null);
        int result;
        String tempValue = platform.toLowerCase();
        if (tempValue.contains("android")) result = RESULT_EMULATOR;
        else result = RESULT_UNKNOWN;
        return new com.zqy.sdk.utils.virtual.CheckResult(result, platform);
    }
     ...
     * @return 0表示可能是模拟器，1表示模拟器，2表示可能是真机
     */
    private com.zqy.sdk.utils.virtual.CheckResult checkFeaturesByBaseBand() {
        String baseBandVersion = getProperty("gsm.version.baseband");
        if (null == baseBandVersion) return new com.zqy.sdk.utils.virtual.CheckResult(RESULT_MAYBE_EMULATOR, null);
        int result;
        if (baseBandVersion.contains("1.0.0.0")) result = RESULT_EMULATOR;
        else result = RESULT_UNKNOWN;
        return new com.zqy.sdk.utils.virtual.CheckResult(result, baseBandVersion);
    }
    ...
    private int getUserAppNumber() {
        String userApps = com.zqy.sdk.utils.virtual.CommandUtil.getSingleInstance().exec("pm list package -3");
     ...
     * 特征参数-进程组信息
     */
    private com.zqy.sdk.utils.virtual.CheckResult checkFeaturesByCgroup() {
        String filter = CommandUtil.getSingleInstance().exec("cat /proc/self/cgroup");
        if (null == filter) return new com.zqy.sdk.utils.virtual.CheckResult(RESULT_MAYBE_EMULATOR, null);
