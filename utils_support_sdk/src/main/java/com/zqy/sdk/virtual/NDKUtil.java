...
public class NDKUtil {
    ...
    private static com.zqy.sdk.virtual.LibLoader localLibLoader = new com.zqy.sdk.virtual.LibLoader() {
        @Override
     ...
     * @param libLoader
     */
    public static void loadLibrariesOnce(com.zqy.sdk.virtual.LibLoader libLoader) {
    ...
    public NDKUtil(com.zqy.sdk.virtual.LibLoader libLoader) {
        initNDK(libLoader);
    }
